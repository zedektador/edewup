<?php
	...
	if($mess != $hey){
		header("location:reservation_list.php?id=$in_id&mess=The rooms you selected do not match the actual number of rooms.");
	}
	else{
	...
	header("location:reservation_list.php?message=Guest successfully checked-in!");	
