...
include './auth.php';
$sql = "UPDATE booking SET isReserved=1, isCancelled = 0 WHERE booking_id=" . $booking_id . "";
...
echo "		<h4> Added to pending Success. Please wait few seconds for redirection...<i class=\"icon-spin4 animate-spin\" style=\"font-size:28px;\"></i></h4>\n";
echo "		\n";
echo "		</div>\n";
echo "		<div class=\"col-xs-3\">\n";
echo "		</div>\n";
