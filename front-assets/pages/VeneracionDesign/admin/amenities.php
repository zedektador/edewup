                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div class="table-responsive">
                            <a href="add-amenity.php" class="btn btn-primary"><i class="fa fa-plus"></i> Add Amenity</a><br/><br/>
                            <table class="table table-striped" id="roomtable">
                                ...
                                <tbody>
                                    <?php
include './auth.php';
$re = mysql_query("SELECT * from amenities WHERE isCocoylandia = 0");
if (mysql_num_rows($re) > 0) {
    while ($row = mysql_fetch_array($re)) {
        echo '
                                                    <tr>
                                                        ...
                                                        <td>' . $row['quantity'] . '</td>
                                                        <td>₱ ' . $row['price'] . '</td>
                                                        <td><a class="btn btn-primary" href="edit-amenity.php?amenity_id=' . $row['amenity_id'] . '">Edit</a></td>
                                                        <td><a class="btn btn-danger deletebtn" id="deletebtn" href="deleteamenity.php?amenity_id=' . $row['amenity_id'] . '">Delete</a></td>
                                                    </tr>
                                                ';
    }
}
