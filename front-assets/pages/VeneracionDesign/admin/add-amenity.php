                ...
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" id="formnew" action="addamenity.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="amenity_name">Amenity Name</label>
                                    <input type="text" class="form-control" name="amenity_name" id="amenity_name" placeholder="Amenity Name" required>
                                </div>
                                <div class="form-group">
                                    <label for="quantity">Quantity</label>
                                    <input type="number" class="form-control" name="quantity" id="quantity" placeholder="Number of amenity" required>
                                </div>
                                <div class="form-group">
                                    <label for="price">Price</label>
                                    <input type="number" class="form-control" name="price" id="price" placeholder="Rate of the amenity" required>
                                </div>
