...
<html>
	<head>
		<title>El Renzo Hotel | Contact Us</title>
...
<h4>El Renzo Hotel - Tagaytay<br/> </h4>
<?php
...
?>
<h5><?php echo $rowset["ContactNumber"]; ?></h5>
<h5><?php echo $rowset["EmailAddress"]; ?></h5>
  </div>

  <form action="sendemail.php" method="post" id="contact_form">
    <div class="name">
      <label for="name"></label>
      <input type="text" placeholder="name" maxlength="50" name="name" id="name_input" required>
    </div>
    <div class="telephone">
      <label for="name"></label>
      <input type="text" placeholder="Contact number (e.g. 09XXXXXXXXX)" name="telephone" maxlength="11" onkeypress="return isNumberKey(event)" id="telephone_input" required>
    </div>
    <div class="email">
      <label for="email"></label>
      <input type="email" placeholder="Email Address" maxlength="50" name="email" id="email_input" required>
    </div>
    
    <div class="subject">
      <label for="subject"></label>
      <input type="text" placeholder="Subject" name="subject" maxlength="100" id="subject_input" required>
    </div>
    <div class="message">
      <label for="message"></label>
      <textarea name="message" placeholder="Message" id="message_input" maxlength="65535" cols="30" rows="5" required></textarea>
    </div>
    <div class="submit">
...
<div>
  <a href="#" class="map-toggle arrow" id="map1">locate us on the map</a>
      <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3869.8246536743018!2d120.89055065017382!3d14.087526093172485!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33bd9d7f0bb10ef9%3A0x6c2f2ffc9e34989c!2sEL+Renzo+Hotel+Tagaytay!5e0!3m2!1sen!2sph!4v1484651426574" width="100%" height="350" frameborder="0" style="border:0" allowfullscreen></iframe>
